...
@ZenRegister
@Document("mods/lootoverhaul/loot/condition/PlayerTotemUseOnBattleCondition")
@ZenCodeType.Name("mods.lootoverhaul.loot.condition.PlayerTotemUseOnBattleCondition")
